...
const providers = [
  ...
  ['Social launch tables', 'test-social-launch', 'Profiles, direct messages, notifications, and reports'],
  ['Supabase media storage', 'test-media-storage', 'Avatars, banners, post media, and music uploads'],
  ['Google AI', 'test-google-ai', 'Primary Entity image generation'],
  ['Stripe', 'test-stripe', 'Static+, Creator Pro, Static Coins, and webhook fulfillment'],
  ...
  ['Cloudflare R2', 'upload-media', 'Public provider media handoff'],
]
