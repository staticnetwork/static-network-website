...
export function planSageAction(parsed) {
  ...
  return { type: 'respond', response: 'I can navigate STATIC, guide your City OS setup, explain what is real versus preview, open creative tools, prefill a Signal, check providers, or start the tour.' }
}
